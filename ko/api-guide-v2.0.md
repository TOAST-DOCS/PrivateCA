...
| Method | URI | 설명 |
|--------|-----|------|
| GET | /v2.0/appkeys/{appkey}/ca-stores | 저장소 목록을 조회합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores | 저장소를 생성합니다. |
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId} | 저장소 상세 정보를 조회합니다. |
| PUT | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId} | 저장소를 수정합니다. |
| DELETE | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId} | 저장소를 삭제합니다. |

#### 인증서(발급자)

| Method | URI | 설명 |
|--------|-----|------|
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs | 인증서 목록을 조회합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs | 인증서(발급자)를 발급합니다. ROOT, INTERMEDIATE만 발급 가능합니다. |
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{certId} | 인증서 상세 정보를 조회합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{certId}/revoke | 인증서를 폐기합니다. |

#### 템플릿

| Method | URI | 설명 |
|--------|-----|------|
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/templates | 템플릿 목록을 조회합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/templates | 템플릿을 생성합니다. |
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/templates/{templateId} | 템플릿 상세 정보를 조회합니다. |
| PUT | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/templates/{templateId} | 템플릿을 수정합니다. |
| DELETE | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/templates/{templateId} | 템플릿을 삭제합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/templates/{templateId}/certificates | 템플릿으로 인증서를 발급합니다. |

#### 인증서 다운로드

| Method | URI | 설명 |
|--------|-----|------|
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{certId}/download | PEM 형식의 인증서를 다운로드합니다. |

#### CRL

| Method | URI | 설명 |
|--------|-----|------|
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{issuerCertId}/crl | CRL 정보(PEM, 발행/갱신 시간)를 조회합니다. |
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{issuerCertId}/crl/der | DER 형식의 CRL을 다운로드합니다. |
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{issuerCertId}/crl/pem | PEM 형식의 CRL을 다운로드합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/certs/{issuerCertId}/crl | CRL을 수동으로 갱신합니다. |

#### OCSP

| Method | URI | 설명 |
|--------|-----|------|
| GET | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/ocsp/{ocspRequestBase64} | Base64 인코딩된 OCSP 요청으로 인증서 상태를 조회합니다. |
| POST | /v2.0/appkeys/{appkey}/ca-stores/{caStoreId}/ocsp | DER 형식의 OCSP 요청으로 인증서 상태를 조회합니다. |
...
!!! danger "주의"
    ROOT, INTERMEDIATE 인증서만 발급 가능합니다. LEAF 인증서는 템플릿을 통해 발급해야 합니다.
...
| keyInfo | Object | Y | 키 정보 | 하단 참조 |
| signatureBits | Number | N | 서명 비트 수 | `256`, `384`, `512`, 기본값: `256`, ED25519의 경우 무시됨 |
