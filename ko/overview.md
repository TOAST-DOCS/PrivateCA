...
- OCSP(Online Certificate Status Protocol)를 통해 인증서 상태를 확인할 수 있습니다.
...
![Private CA 서비스 구조](../pca_images/pca_overview_architecture.png)
...
- 동일한 설정으로 여러 인증서를 쉽게 발급할 수 있으며, 다음 두 가지 설정으로 구성됩니다.
  ...
  - **공통 반영 설정**: 키 알고리즘, 키 사용 용도, 확장 키 사용, 주체 정보 등 인증서에 공통으로 적용할 설정을 정의합니다.
...
- [API v2.0 가이드](./api-v2-guide.md): API를 통해 인증서를 다운로드하고 CRL, OCSP를 조회하는 방법을 안내합니다.
